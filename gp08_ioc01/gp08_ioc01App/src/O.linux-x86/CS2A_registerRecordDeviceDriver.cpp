...
/* Generated from ../O.Common/CS2A.dbd */
...
int CS2A_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/controls/ioc/ebtf/CS2A";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"CS2A_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    CS2A_registerRecordDeviceDriver(*iocshPpdbbase);
}
