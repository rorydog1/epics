...
QT_MOC_LITERAL(3, 24, 8) // "setValue"
    ...
    "rectangle\0valueChanged\0\0setValue"
};
...
void rectangle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (rectangle::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&rectangle::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject rectangle::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rectangle.data,
