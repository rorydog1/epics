...
struct qt_meta_stringdata_caPolyLineDialog_t {
    QByteArrayData data[4];
    char stringdata0[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_caPolyLineDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_caPolyLineDialog_t qt_meta_stringdata_caPolyLineDialog = {
    {
QT_MOC_LITERAL(0, 0, 16), // "caPolyLineDialog"
QT_MOC_LITERAL(1, 17, 10), // "resetState"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 9) // "saveState"

    },
    "caPolyLineDialog\0resetState\0\0saveState"
};
...
const QMetaObject caPolyLineDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_caPolyLineDialog.data,
      qt_meta_data_caPolyLineDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *caPolyLineDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_caPolyLineDialog.stringdata0))
