...
struct qt_meta_stringdata_EApplyButton_t {
    QByteArrayData data[4];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EApplyButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EApplyButton_t qt_meta_stringdata_EApplyButton = {
    {
QT_MOC_LITERAL(0, 0, 12), // "EApplyButton"
QT_MOC_LITERAL(1, 13, 13), // "valueModified"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 13) // "clearModified"

    },
    "EApplyButton\0valueModified\0\0clearModified"
};
...
const QMetaObject EApplyButton::staticMetaObject = {
    { &EPushButton::staticMetaObject, qt_meta_stringdata_EApplyButton.data,
      qt_meta_data_EApplyButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EApplyButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EApplyButton.stringdata0))
