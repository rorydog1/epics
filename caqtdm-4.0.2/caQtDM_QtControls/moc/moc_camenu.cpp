...
static const uint qt_meta_data_caMenu[] = {
 ...
 // enum data: key, value
     108, uint(caMenu::on_top),
     115, uint(caMenu::as_is),
     121, uint(caMenu::Default),
     129, uint(caMenu::Static),
     136, uint(caMenu::Alarm),
...
static const char qt_meta_stringdata_caMenu[] = {
    ...
    "labelDisplay\0Elevation\0elevation\0"
    "on_top\0as_is\0Default\0Static\0Alarm\0"
};
...
int caMenu::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        ...
        case 5: *reinterpret_cast< Elevation*>(_v) = getElevation(); break;
        }
        _id -= 6;
        ...
        case 5: setElevation(*reinterpret_cast< Elevation*>(_v)); break;
        }
        _id -= 6;
