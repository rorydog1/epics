...
struct qt_meta_stringdata_caDoubleTabWidgetExtension_t {
    QByteArrayData data[1];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_caDoubleTabWidgetExtension_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_caDoubleTabWidgetExtension_t qt_meta_stringdata_caDoubleTabWidgetExtension = {
    {
QT_MOC_LITERAL(0, 0, 26) // "caDoubleTabWidgetExtension"

    },
    "caDoubleTabWidgetExtension"
};
...
const QMetaObject caDoubleTabWidgetExtension::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_caDoubleTabWidgetExtension.data,
      qt_meta_data_caDoubleTabWidgetExtension,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *caDoubleTabWidgetExtension::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_caDoubleTabWidgetExtension.stringdata0))
