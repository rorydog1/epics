...
void MainWindow::createActionMaps()
{
    ...
    inbuiltFormMap.insert( QEActionRequests::actionShowInHisogram(), ":/qe/gui/forms/Histogram.ui" );
...
void  MainWindow::requestAction( const QEActionRequests & request )
{
    ...
    switch( request.getKind () )
    {
        ...
        case QEActionRequests::KindOpenFile:
            ...
            {
               launchGui ( arguments.first(), "", request.getCustomisation(), request.getOption(), true, request.getFormHandle() );
            }
            break;
