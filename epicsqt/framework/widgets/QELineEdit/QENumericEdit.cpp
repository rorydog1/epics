                                    ...
                                    QCaDateTime& dateTime, const unsigned int& variableIndex)
{
   ...
   formattedText = this->fpr.toString (valueIn,
                                       this->showSign (),
                                       this->getLeadingZeros (),
                                       this->getPrecision ());
   this->emitDbValueChanged (formattedText, 0);
}

//------------------------------------------------------------------------------
//
int QENumericEdit::getRadixValue () const
{
...
//------------------------------------------------------------------------------
//
int QENumericEdit::maximumSignificance () const
{
...
//------------------------------------------------------------------------------
//
QString QENumericEdit::imageOfValue () const
{
   QString image;

   image = this->fpr.toString (this->mValue,
                               this->showSign (),
                               this->getLeadingZeros (),
                               this->getPrecision ());
...
//------------------------------------------------------------------------------
//
int QENumericEdit::getPropertyPrecision () const
{
...
//------------------------------------------------------------------------------
//
int QENumericEdit::getPropertyLeadingZeros () const
{
...
//------------------------------------------------------------------------------
//
double QENumericEdit::getPropertyMinimum () const
{
...
//------------------------------------------------------------------------------
//
double QENumericEdit::getPropertyMaximum () const
{
...
//------------------------------------------------------------------------------
//
void QENumericEdit::setArrayIndex (const int arrayIndexIn)
{
...
//------------------------------------------------------------------------------
//
int QENumericEdit::getArrayIndex () const
{
...
//------------------------------------------------------------------------------
//
QEFixedPointRadix::Radicies QENumericEdit::getRadix () const
{
...
//------------------------------------------------------------------------------
//
QEFixedPointRadix::Separators QENumericEdit::getSeparator () const
{
...
//------------------------------------------------------------------------------
//
bool QENumericEdit::showSign () const
{
