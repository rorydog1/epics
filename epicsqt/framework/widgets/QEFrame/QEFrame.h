...
public:
    void setPixmap( QPixmap pixmapIn );                 // Set the pixmap used for the background. Operates like pixmap property for QLabel
    QPixmap getPixmap() const;                          // Get the pixmap used for the background. Operates like pixmap property for QLabel
    ...
    bool getScaledContents();                           // Get the flag used to indicate the background is to be scaled to fit the frame. Similar operation to scaledContents property for a QLabel
...
private:
    QPixmap pixmap;                     // Pixmap used for the background. Operates like pixmap property for QLabel
    bool scaledContents;                // Flag the pixmap for the background is to be scaled to fit the frame. Similar operation to scaledContents property for a QLabel
